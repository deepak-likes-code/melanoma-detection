...
(async function () {
	...
	model = await tf.loadModel('https://deepak-netizen.github.io/melanoma-detection/final_model_kaggle_version1/model.json');
	$("#selected-image").attr("src", "https://deepak-netizen.github.io/melanoma-detection/assets/samplepic.jpg");
